<style>
    ...
    <img class="widescroll-top" src="img/scroll/backdrop_765_top.gif" alt="" width="765" height="50">
		...
		<div class="widescroll" style="background-color: black;">
      
<div class="widescroll-bgimg" style="height: auto;" >
<div class="widescroll-content">
<div class="col-sm-6 col-md-4">
<main id="content" class="twelve-eighty" style="    display: inline;">
  {snippet:notices}

  <?php echo functions::form_draw_form_begin('checkout_form', 'post', document::ilink('order_process')); ?>

  <div id="box-checkout" class="" style="color: black;">
