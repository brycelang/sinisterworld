...
<div class="col-sm-6 col-md-4">
 <h1 class="title" style="font-size: 70px;"> <?php echo $name; ?></h1>
...
<br>
 ...
 <div class="price-wrapper">
        ...
        <?php } else { ?>
        <span class="price" style="font-size: 30px;"><?php echo currency::format($regular_price); ?></span>
        <?php } ?>
      </div><br>
<?php if ($short_description) { ?>
      <p class="short-description" style="font-size: 15px;">
...
<br>
<td style="vertical-align: top; width: 240px;"><span style="font-size: 14px; display: inline;"><b>Features</b></span>
...
<td style="vertical-align: top; width: 200px;"><span style="font-size: 14px; display: inline;">
  <!-- <b>Size</b> </span><br> -->
